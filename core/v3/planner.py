...
def plan_resume(
    ...
    for record_id, fact_ids in facts_by_record.items():
        if record_id is not None:
            ...
            section = next((item.section_type for item in fact_graph.sections if record and item.section_id == record.section_id), "experience")
            ...
            for fact_id in fact_ids:
                ...
                section = next((item.section_type for item in fact_graph.sections if item.section_id == fact.section_id), "other")
